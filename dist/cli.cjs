...
var B__default = /*#__PURE__*/_interopDefaultLegacy(B$1);
...
const C$1=/-(\w)/g,E=t=>t.replace(C$1,(e,r)=>r.toUpperCase()),P$2=/\B([A-Z])/g,O$1=t=>t.replace(P$2,"-$1").toLowerCase(),{stringify:d$2}=JSON,{hasOwnProperty:x$2}=Object.prototype,y$1=(t,e)=>x$2.call(t,e),j$2=/^--?/,D$1=/[.:=]/,I$1=t=>{let e=t.replace(j$2,""),r;const s=e.match(D$1);if(s!=null&&s.index){const n=s.index;r=e.slice(n+1),e=e.slice(0,n);}return {flagName:e,flagValue:r}},T$2=/[\s.:=]/,U$2=(t,e)=>{const r=`Invalid flag name ${d$2(e)}:`;if(e.length===0)throw new Error(`${r} flag name cannot be empty}`);if(e.length===1)throw new Error(`${r} single characters are reserved for aliases`);const s=e.match(T$2);if(s)throw new Error(`${r} flag name cannot contain the character ${d$2(s==null?void 0:s[0])}`);let n;if(C$1.test(e)?n=E(e):P$2.test(e)&&(n=O$1(e)),n&&y$1(t,n))throw new Error(`${r} collides with flag ${d$2(n)}`)};function L$2(t){const e=new Map;for(const r in t){if(!y$1(t,r))continue;U$2(t,r);const s=t[r];if(s&&typeof s=="object"){const{alias:n}=s;if(typeof n=="string"){if(n.length===0)throw new Error(`Invalid flag alias ${d$2(r)}: flag alias cannot be empty`);if(n.length>1)throw new Error(`Invalid flag alias ${d$2(r)}: flag aliases can only be a single-character`);if(e.has(n))throw new Error(`Flag collision: Alias "${n}" is already used`);e.set(n,{name:r,schema:s});}}}return e}const M$2=t=>!t||typeof t=="function"?!1:Array.isArray(t)||Array.isArray(t.type),z$2=t=>{const e={};for(const r in t)y$1(t,r)&&(e[r]=M$2(t[r])?[]:void 0);return e},A$1=(t,e)=>t===Number&&e===""?Number.NaN:t===Boolean?e!=="false":e,B=(t,e)=>{for(const r in t){if(!y$1(t,r))continue;const s=t[r];if(!s)continue;const n=e[r];if(!(n!==void 0&&!(Array.isArray(n)&&n.length===0))&&"default"in s){let o=s.default;typeof o=="function"&&(o=o()),e[r]=o;}}},_$1=(t,e)=>{if(!e)throw new Error(`Missing type on flag "${t}"`);return typeof e=="function"?e:Array.isArray(e)?e[0]:_$1(t,e.type)},K$2=/^-[\da-z]+/i,q$1=/^--[\w-]{2,}/,F$1="--";function G$2(t,e=process.argv.slice(2),r={}){const s=L$2(t),n={flags:z$2(t),unknownFlags:{},_:Object.assign([],{[F$1]:[]})};let o;const v=(i,a,l)=>{const c=_$1(i,a);l=A$1(c,l),l!==void 0&&!Number.isNaN(l)?Array.isArray(n.flags[i])?n.flags[i].push(c(l)):n.flags[i]=c(l):o=f=>{Array.isArray(n.flags[i])?n.flags[i].push(c(A$1(c,f||""))):n.flags[i]=c(A$1(c,f||"")),o=void 0;};},b=(i,a)=>{i in n.unknownFlags||(n.unknownFlags[i]=[]),a!==void 0?n.unknownFlags[i].push(a):o=(l=!0)=>{n.unknownFlags[i].push(l),o=void 0;};};for(let i=0;i<e.length;i+=1){const a=e[i];if(a===F$1){const f=e.slice(i+1);n._[F$1]=f,n._.push(...f);break}const l=K$2.test(a);if(q$1.test(a)||l){o&&o();const f=I$1(a),{flagValue:w}=f;let{flagName:u}=f;if(l){for(let g=0;g<u.length;g+=1){const $=u[g],h=s.get($),k=g===u.length-1;h?v(h.name,h.schema,k?w:!0):r!=null&&r.ignoreUnknown?n._.push(a):b($,k?w:!0);}continue}let p=t[u];if(!p){const g=E(u);p=t[g],p&&(u=g);}if(!p){r!=null&&r.ignoreUnknown?n._.push(a):b(u,w);continue}v(u,p,w);}else o?o(a):n._.push(a);}return o&&o(),B(t,n.flags),n}
...
`)),t)return {id:"examples",type:"section",data:{title:"Examples:",body:t}}}function k(r){if(!("alias"in r)||!r.alias)return;const{alias:e}=r,t=Array.isArray(e)?e.join(", "):e;return {id:"aliases",type:"section",data:{title:"Aliases:",body:t}}}const W=r=>[F,H,U,V,J,M,k].map(e=>e(r)).filter(e=>Boolean(e)),Z=B__default["default"].WriteStream.prototype.hasColors();class z{text(e){return e}bold(e){return Z?`\x1B[1m${e}\x1B[22m`:e.toLocaleUpperCase()}indentText({text:e,spaces:t}){return e.replace(/^/gm," ".repeat(t))}heading(e){return this.bold(e)}section({title:e,body:t,indentBody:n=2}){return `${(e?`${this.heading(e)}
...
function run(argv, options) {
  ...
  return crossSpawn.exports(
    ...
    [
      ...
      "--loader",
      url.pathToFileURL(pkgroll_createRequire.require.resolve("./loader.js")).toString(),
      ...argv
    ],
    {
      stdio,
...
const sysPath$3 = require$$0__default$1["default"];
...
(function (exports) {
	...
	const {sep} = require$$0__default$1["default"];
...
const sysPath$2 = require$$0__default$1["default"];
...
const sysPath$1 = require$$0__default$1["default"];
const { promisify: promisify$1 } = require$$2__default["default"];

let fsevents;
try {
  fsevents = pkgroll_createRequire.require('fsevents');
} catch (error) {
...
const sysPath = require$$0__default$1["default"];
...
function isDependencyPath(data) {
...
const watchCommand = ne({
  ...
  const reRun = debounce(() => {
    ...
    runProcess.on("message", (data) => {
      if (isDependencyPath(data)) {
        ...
        if (require$$0__default$1["default"].isAbsolute(dependencyPath)) {
  ...
  function exit(signal) {
    process.exit(
      128 + require$$2$1.constants.signals[signal]
    );
  }
...
ae({
  ...
  if (noArgs) {
    ...
    process.argv.push(pkgroll_createRequire.require.resolve("./repl"));
  }
  const args = G$2(
