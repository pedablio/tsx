#!/usr/bin/env node
import { r as require } from './pkgroll_create-require-29e8d982.js';
...
import require$$2$1, { constants as constants$5 } from 'os';
...
`)),t)return {id:"examples",type:"section",data:{title:"Examples:",body:t}}}function k(r){if(!("alias"in r)||!r.alias)return;const{alias:e}=r,t=Array.isArray(e)?e.join(", "):e;return {id:"aliases",type:"section",data:{title:"Aliases:",body:t}}}const W=r=>[F,H,U,V,J,M,k].map(e=>e(r)).filter(e=>Boolean(e)),Z=B$1.WriteStream.prototype.hasColors();class z{text(e){return e}bold(e){return Z?`\x1B[1m${e}\x1B[22m`:e.toLocaleUpperCase()}indentText({text:e,spaces:t}){return e.replace(/^/gm," ".repeat(t))}heading(e){return this.bold(e)}section({title:e,body:t,indentBody:n=2}){return `${(e?`${this.heading(e)}
...
const watchCommand = ne({
  ...
  const reRun = debounce(() => {
    ...
    runProcess.on("message", (data) => {
      if (isDependencyPath(data)) {
        ...
        if (require$$0$2.isAbsolute(dependencyPath)) {
  ...
  function exit(signal) {
    process.exit(
      128 + constants$5.signals[signal]
    );
  }
